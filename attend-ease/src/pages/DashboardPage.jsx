...
function AdminQuickLinks() { return <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm"><h2 className="font-bold text-slate-900">Quick actions</h2><div className="mt-4 space-y-3"><QuickAction icon={FiPlayCircle} label="View attendance" to="/attendance" /><QuickAction icon={FiCalendar} label="Review leave" to="/leave" /><QuickAction icon={FiDollarSign} label="Generate payroll" to="/payroll" /></div></section> }
