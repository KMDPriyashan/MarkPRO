...
export default function LeavePage() {
  ...
  function handleCancel() { if (cancelLeave(cancelingLeave.id, employeeId)) { refresh(); setCancelingLeave(null); toast.success('Leave request cancelled.') } }
